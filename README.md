# genpark-sandboxed-terminal-computer-control-interpreter-skill
...
> **GenPark AI Agent Skill** -- Sandboxed terminal code interpreter and computer control automator (Open Interpreter style)
